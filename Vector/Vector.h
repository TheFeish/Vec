...
class Vec {
    public:
        ...
        reverse_iterator rbegin() { return make_reverse_iterator(start); }
        const_reverse_iterator rbegin() const { return make_reverse_iterator(start); }
        const_reverse_iterator crbegin() const { return make_reverse_iterator(start); }
        iterator end() { return avail; }
        const_iterator end() const { return avail; }
        const_iterator cend() const { return avail; }
        reverse_iterator rend() { return make_reverse_iterator(avail); }
        const_reverse_iterator rend() const { return make_reverse_iterator(avail); }
        const_reverse_iterator crend() const { return make_reverse_iterator(avail); }
